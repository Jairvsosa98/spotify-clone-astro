...
const $$Home = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Home;
  return renderTemplate`${maybeRenderHead()}<svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 24 24" height="16" width="16" fill="currentColor"><path d="M12.5 3.247a1 1 0 0 0-1 0L4 7.577V20h4.5v-6a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v6H20V7.577l-7.5-4.33zm-2-1.732a3 3 0 0 1 3 0l7.5 4.33a2 2 0 0 1 1 1.732V21a1 1 0 0 1-1 1h-6.5a1 1 0 0 1-1-1v-6h-3v6a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V7.577a2 2 0 0 1 1-1.732l7.5-4.33z"></path></svg>`;
}, "C:/Users/Jair/Desktop/Astro_Projects/spotify-clone-astro/src/icons/Home.astro", void 0);

const $$Astro$9 = createAstro();
const $$Search = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$9, $$props, $$slots);
  Astro2.self = $$Search;
  return renderTemplate`${maybeRenderHead()}<svg width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor"> <path d="M10.533 1.27893C5.35215 1.27893 1.12598 5.41887 1.12598 10.5579C1.12598 15.697 5.35215 19.8369 10.533 19.8369C12.767 19.8369 14.8235 19.0671 16.4402 17.7794L20.7929 22.132C21.1834 22.5226 21.8166 22.5226 22.2071 22.132C22.5976 21.7415 22.5976 21.1083 22.2071 20.7178L17.8634 16.3741C19.1616 14.7849 19.94 12.7634 19.94 10.5579C19.94 5.41887 15.7138 1.27893 10.533 1.27893ZM3.12598 10.5579C3.12598 6.55226 6.42768 3.27893 10.533 3.27893C14.6383 3.27893 17.94 6.55226 17.94 10.5579C17.94 14.5636 14.6383 17.8369 10.533 17.8369C6.42768 17.8369 3.12598 14.5636 3.12598 10.5579Z"></path> </svg>`;
}, "C:/Users/Jair/Desktop/Astro_Projects/spotify-clone-astro/src/icons/Search.astro", void 0);

const $$Astro$8 = createAstro();
const $$Library = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$8, $$props, $$slots);
  Astro2.self = $$Library;
  return renderTemplate`${maybeRenderHead()}<svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 24 24" height="16" width="16" fill="currentColor"><path d="M3 22a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v18a1 1 0 0 1-1 1zM15.5 2.134A1 1 0 0 0 14 3v18a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V6.464a1 1 0 0 0-.5-.866l-6-3.464zM9 2a1 1 0 0 0-1 1v18a1 1 0 1 0 2 0V3a1 1 0 0 0-1-1z"></path></svg>`;
}, "C:/Users/Jair/Desktop/Astro_Projects/spotify-clone-astro/src/icons/Library.astro", void 0);
...
}, "C:/Users/Jair/Desktop/Astro_Projects/spotify-clone-astro/src/components/SideMenuItem.astro", void 0);
...
}, "C:/Users/Jair/Desktop/Astro_Projects/spotify-clone-astro/src/components/SideMenuCard.astro", void 0);
...
}, "C:/Users/Jair/Desktop/Astro_Projects/spotify-clone-astro/src/components/AsideMenu.astro", void 0);
...
}, "C:/Users/Jair/Desktop/Astro_Projects/spotify-clone-astro/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const Play = ({ className }) => /* @__PURE__ */ jsx("svg", { "data-encore-id": "icon", className, height: "16", width: "16", role: "img", "aria-hidden": "true", viewBox: "0 0 16 16", children: /* @__PURE__ */ jsx("path", { d: "M3 1.713a.7.7 0 0 1 1.05-.607l10.89 6.288a.7.7 0 0 1 0 1.212L4.05 14.894A.7.7 0 0 1 3 14.288V1.713z" }) });
const Pause = ({ className }) => /* @__PURE__ */ jsx("svg", { "data-encore-id": "icon", className, height: "16", width: "16", role: "img", "aria-hidden": "true", viewBox: "0 0 16 16", children: /* @__PURE__ */ jsx("path", { d: "M2.7 1a.7.7 0 0 0-.7.7v12.6a.7.7 0 0 0 .7.7h2.6a.7.7 0 0 0 .7-.7V1.7a.7.7 0 0 0-.7-.7H2.7zm8 0a.7.7 0 0 0-.7.7v12.6a.7.7 0 0 0 .7.7h2.6a.7.7 0 0 0 .7-.7V1.7a.7.7 0 0 0-.7-.7h-2.6z" }) });
const VolumeDown = () => /* @__PURE__ */ jsxs("svg", { "data-encore-id": "icon", width: 16, height: 16, role: "presentation", "aria-label": "Volumen apagado", "aria-hidden": "true", id: "volume-icon", viewBox: "0 0 16 16", fill: "currentColor", children: [
...
const VolumeFull = () => /* @__PURE__ */ jsxs("svg", { "data-encore-id": "icon", width: 16, height: 16, role: "presentation", "aria-label": "Volumen alto", "aria-hidden": "true", id: "volume-icon", viewBox: "0 0 16 16", fill: "currentColor", children: [
...
const CurrentSong = ({ image, title, artists }) => {
  return /* @__PURE__ */ jsxs("div", { className: `flex items-center gap-5 relative overflow-hidden`, children: [
    /* @__PURE__ */ jsx("picture", { className: "w-16 h-16 bg-zinc-600 rounded-md shadow-lg overflow-hidden", children: /* @__PURE__ */ jsx("img", { src: image, alt: title }) }),
...
const VolumeControl = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex justify-center gap-x-2 text-white", children: [
    /* @__PURE__ */ jsx("button", { className: "p-70 hover:opacity-100 transition", onClick: handleClickVolume, children: volume < 0.1 ? /* @__PURE__ */ jsx(VolumeDown, {}) : /* @__PURE__ */ jsx(VolumeFull, {}) }),
    /* @__PURE__ */ jsx(
      Slider,
      {
        defaultValue: [100],
...
function Player() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-row justify-between w-full px-1 z-50", children: [
    /* @__PURE__ */ jsx("div", { className: "w-[250px]", children: /* @__PURE__ */ jsx(CurrentSong, { ...currentMusic.song }) }),
...
}, "C:/Users/Jair/Desktop/Astro_Projects/spotify-clone-astro/src/layouts/Layout.astro", "self");

const $$Astro$2 = createAstro();
const $$Time = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$Time;
  return renderTemplate`${maybeRenderHead()}<svg data-encore-id="icon" fill="currentColor" width="16" height="16" role="img" aria-hidden="true" viewBox="0 0 16 16"><path d="M8 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z"></path><path d="M8 3.25a.75.75 0 0 1 .75.75v3.25H11a.75.75 0 0 1 0 1.5H7.25V4A.75.75 0 0 1 8 3.25z"></path></svg>`;
}, "C:/Users/Jair/Desktop/Astro_Projects/spotify-clone-astro/src/icons/Time.astro", void 0);
...
const $$MusicTable = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<table class="table-auto text-left min-w-full divide-y divide-gray-500/50"> <thead class=""> <tr class="text-zinc-400 text-sm"> <th class="px-4 py-2 font-light">#</th> <th class="px-4 py-2 font-light">Título</th> <th class="px-4 py-2 font-light">Álbum</th> <th class="px-4 py-2 font-light">${renderComponent($$result, "Time", $$Time, {})}</th> </tr> </thead> <tbody> <tr class="h-4"></tr> ${songs.map((song, index) => renderTemplate`<tr class="border-separate border-spacing-0 text-gray-300 text-sm font-light hover:bg-white/10 overflow-hidden transition duration-300"> <td class="px-4 py-2 rounded-tl-lg rounded-bl-lg w-5">${index + 1}</td> <td class="px-4 py-2 flex gap-3"> <picture class=""> <img${addAttribute(song.image, "src")}${addAttribute(song.title, "alt")} class="w-11 h-11 rounded-md"> </picture> <div class="flex flex-col"> <h3 class="text-white text-base font-normal">${song.title}</h3> <span>${song.artists.join(", ")}</span> </div> </td> <td class="px-4 py-2">${song.album}</td> <td class="px-4 py-2">${song.duration}</td> </tr>`)} </tbody> </table>`;
}, "C:/Users/Jair/Desktop/Astro_Projects/spotify-clone-astro/src/components/MusicTable.astro", void 0);
